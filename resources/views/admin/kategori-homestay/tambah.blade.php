...
@section('title', 'Tambah Kategori Homestay')
        ...
        <div class="flex items-center gap-4 mb-8 border-b border-[#F2F0EA] pb-6">
            ...
            <div>
                ...
                <p class="text-xs text-[#8A9C91]">
                    Tambahkan kategori baru untuk memilah homestay di Natasha Homestay.
                </p>
            </div>
        </div>

        <form action="{{ route('admin.kategori-homestay.store') }}" method="POST" class="space-y-6">
            @csrf
