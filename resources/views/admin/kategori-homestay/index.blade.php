...
<div class="space-y-8">
    <div class="bg-white rounded-2xl border border-[#E6E4DD] p-6 sm:p-8 shadow-sm">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            ...
            <x-ui-button href="{{ route('admin.kategori-homestay.create') }}" variant="primary">
                            ...
                            <tr style="border-bottom: 1px solid #F2F0EA; transition: background 0.15s ease;" 
                                ...
                                <td style="padding: 12px 16px; text-align: left;">
                                    <div class="inline-flex items-center gap-2">
                                        <x-ui-button href="{{ route('admin.kategori-homestay.edit', $category->kategori_id) }}" variant="secondary" size="sm">
                                            Edit
                                        </x-ui-button>
