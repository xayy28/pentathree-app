...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-xs sm:text-sm text-[#5C6E65]">
                Lengkapi formulir di bawah ini untuk mendaftarkan souvenir baru ke dalam sistem.
            </p>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-[#E6E4DD] p-6 sm:p-8 shadow-sm">
        <form action="{{ route('admin.souvenir.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
