...
{
    /**
     * Tampilkan daftar souvenir (admin & user).
     */
    public function index(Request $request)
    {
        ...
        return view('souvenir.index', compact('souvenirs', 'kategori'));
    }
    ...
    {
        return view('souvenir.tambahSouvenir');
    }
    ...
    public function edit($souvenir_id)
    {
        ...
        return view('souvenir.editSouvenir', compact('souvenir'));
    }
